...
const allIntegrations: Integration[] = [
    ...
    { name: "Company Profile System", icon: Briefcase, milestones: ['V1'] },
    { name: "People Data Labs (Companies & People)", icon: Database, milestones: ['V1.1'], cost: "$1,325.00/mo", requests: "5,000 Credits / month" },
...
const milestones: Milestone[] = [
  ...
  {
    title: 'V1.1: Recruiter Toolkit & Data Enrichment',
    date: 'Target: August 5, 2025',
    successMetrics: [
      'Launch on-demand data enrichment with People Data Labs as a paid feature.',
      'Onboard first 10 beta recruiters to test search and data enrichment.',
      'Achieve first paying customers and validate pricing model.',
      'Integrate with major ATS & productivity suites (Greenhouse, Lever).',
    ],
  },
  {
    title: 'V1.2',
